...
function describe(path, value) {
    ...
    const ranges = {window_gap: [-256,256], control_size: [24,96], control_icon_size: [16,64], font_size: [6,72], editor_font_size: [6,72], spacing: [0,128], padding: [0,128], radius: [0,128], border_width: [0,16], opacity: [0,1,0.01], icon_size: [8,128], panel_padding: [0,128], module_height: [16,256], popup_width: [240,1920], popup_height: [240,2160], popup_gap: [0,256], animation_ms: [0,2000], thickness: [16,512], length: [0,32768], exclusive_zone: [-1,32768], min_width: [16,1024], max_width: [16,2048], interval_ms: [100,86400000], timeout_ms: [100,600000], first_day_of_week: [0,1], max_percent: [1,150], debounce_ms: [10,2000], history_limit: [1,1000], default_expire_ms: [100,86400000], max_expire_ms: [100,86400000], reload_delay_ms: [50,10000]}
