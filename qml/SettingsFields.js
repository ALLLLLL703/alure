...
function describe(path, value) {
    ...
    if (path.startsWith("modules.clipboard.behavior.")) {
        const clipboardRanges = {max_items:[1,1000], max_bytes:[1024,67108864], max_image_pixels:[1024,67108864], preview_image_size:[64,1024], preview_text_chars:[128,65536], cursor_timeout_ms:[50,3000], cursor_gap:[0,128]}
