.pragma library
function title(name) {
    const names = {tray_launcher: "Tray launcher", media_launcher: "Media launcher", taskbar: "Task Manager", clipboard: "Clipboard", workspaces: "Workspaces", media: "Now playing", tray: "System tray", volume: "Sound", brightness: "Brightness", updates: "Updates", wifi: "Wi-Fi", bluetooth: "Bluetooth", notifications: "Notifications", calendar: "Calendar", battery: "Battery"}
...
function moduleDescription(name) {
    const descriptions = {
        ...
        media_launcher: "Search current MPRIS players and control one in the same window.",
